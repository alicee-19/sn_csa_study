  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-4 sm:p-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 mb-4">
        <h2 className="text-xl sm:text-2xl font-semibold text-gray-700">Your Progress</h2>
        {!showConfirm ? (
          <button
      ...
      <div className="grid grid-cols-2 gap-3 sm:gap-4 mb-4">
        <div className="p-3 sm:p-4 bg-gray-50 rounded-md">
          ...
          <p className="text-2xl sm:text-3xl font-bold text-gray-800">{attempted}/{totalQuestions}</p>
        </div>
        <div className="p-3 sm:p-4 bg-green-50 rounded-md">
          <p className="text-xs sm:text-sm text-gray-600">Mastered</p>
          <p className="text-2xl sm:text-3xl font-bold text-green-600">{mastered}</p>
        </div>
        ...
        <div className="p-3 sm:p-4 bg-purple-50 rounded-md">
          ...
          <p className="text-2xl sm:text-3xl font-bold text-purple-600">{overallAccuracy}%</p>
        </div>
      </div>
